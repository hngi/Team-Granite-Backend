...
const user = {
    ...
    getUserFirstName: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User first name', data: firstName}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    },
    getUserLastName: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User last name', data: lastName}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    },
    ...
    getUserEmail: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User email', data: email}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    },
    getUserPhone: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User phone number', data: phone}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    }, 
    setUserAge: (req, res) =>{
        const {age} = req.body;
    ...
    getUserAge: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User age', data: age}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    },
    ...
    getUserStatus: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User status', data: status}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    },
    ...
    getUserGender: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User gender', data: gender}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
    ...
    getUserAddress: (req, res) =>{
        userModel.findOne({_id: req.params.id}).then(user => res.json({status: 'Success', message: 'User address', data: address}))
        .catch((err) => res.status(400).json({status: 'Failed', message: err, data: null}));
